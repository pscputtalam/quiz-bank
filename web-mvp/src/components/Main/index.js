...
const Main = ({ startQuiz }) => {
  ...
  const fetchData = () => {
    ...
    const API = `https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-fmypv/endpoint/quiz?amount=${numOfQuestions}&difficulty=${difficulty}`
      ...
      .then(data =>
        setTimeout(() => {
          ...
          results.map(element => {
            ...
            element.correct_answer = element['ans' + element.ans]
